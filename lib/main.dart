...
part 'data/calendar/calendar_models.dart';
part 'data/calendar/calendar_repository.dart';
part 'features/calendar/calendar_sync_service.dart';
...
part 'screens/settings/settings_calendar_page.dart';
